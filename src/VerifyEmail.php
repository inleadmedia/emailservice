...
/**
 * @file
 * Helper for verifying and validate email adresses.
 */

use Symfony\Component\Validator\Constraints as Assert;
use VerifyEmailException;

/**
 * Class VerifyEmail.
 *
 * Utility for verifying Email addresses.
 *
...
class VerifyEmail {
   ...
   *
   * @return bool
   *   True if the valid email also exist
   *
   * @throws \VerifyEmailException
   */
  public function check($email) {
    ...
    switch ($code) {
      ...
      case '452':
         ...
         * email address was greylisted (or some temporary error occured on
         * the MTA)
